...
;;;;; latex
            ...
            `(font-latex-match-reference-keywords ((,class (:foreground ,blue))))
...
;;;;; magit
            ...
            `(magit-branch ((,class (:foreground ,blue :inherit bold))))
...
;;;;; other, need more work
            ...
            `(js2-private-function-call ((,class (:foreground ,blue))))
