...
;;;;; rainbow-delimiters
            `(rainbow-delimiters-depth-1-face ((,class :foreground ,white)))
            `(rainbow-delimiters-depth-2-face ((,class :foreground ,xgrey6)))
            `(rainbow-delimiters-depth-3-face ((,class :foreground ,xgrey5)))
            `(rainbow-delimiters-depth-4-face ((,class :foreground ,xgrey4)))
            `(rainbow-delimiters-depth-5-face ((,class :foreground ,xgrey3)))
            `(rainbow-delimiters-depth-6-face ((,class :foreground ,xgrey2)))
            `(rainbow-delimiters-depth-7-face ((,class :foreground ,xgrey1)))
            `(rainbow-delimiters-depth-8-face ((,class :foreground ,bright-black)))
