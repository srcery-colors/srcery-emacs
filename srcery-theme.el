...
(defun create-srcery-theme (theme-name)
  (dyn-let ((class '((class color) (min-colors 89)))
            ...
            (gray           (if (true-color-p) "#918175" "white"))
            (white          (if (true-color-p) "#FCE8C3" "brightwhite"))
            (orange         (if (true-color-p) "#D75F00" "color-166"))
            (bright_orange  (if (true-color-p) "#FF8700" "color-208"))
            (hard_black     (if (true-color-p) "#080808" "color-232"))
            (alt_gray       (if (true-color-p) "#4E4E4E" "color-239"))
            )
